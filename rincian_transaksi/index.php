    ...
    <div class="container">
      <div class="row">
        <div class="panel panel-primary">
          <div class="panel-heading">Jenis Rincian Transaksi</div>
 ...
 <a class='btn btn-success' href="tambah.php"><span class="glyphicon glyphicon-plus"><font face="Impact"> Tambah Data</font></span></a>
  <center>
      ...
      <tr>
        ...
        <th bgcolor="#1976d2"><font color="white">ID Rincian</font></th>
        ...
        <th bgcolor="#1976d2"><font color="white">OPSI</font></th>
          ...
          <?php
          include'koneksi.php';
          $data =mysqli_query($koneksi,"SELECT rincian_transaksi.id_rincian,
                                               rincian_transaksi.id_jenis_pakaian,
                                               rincian_transaksi.no_transaksi,
                                               rincian_transaksi.jumlah,
                                               tarif.nama_pakaian,
                                               transaksi.tgl_transaksi
                                               FROM rincian_transaksi INNER JOIN tarif ON 
                                               tarif.id_jenis_pakaian=rincian_transaksi.id_jenis_pakaian
                                               INNER JOIN transaksi ON transaksi.no_transaksi=rincian_transaksi.no_transaksi");
          $no=1;
          foreach ($data as $dataa) 
          {
            echo  "<tr>
                <td>$no</td>
                    <td>".$dataa['id_rincian']."</td>
                    <td>".$dataa['jumlah']."</td>
                     <td>".$dataa['nama_pakaian']."</td>
                    <td>".$dataa['tgl_transaksi']."</td>
                    <td>
              <a href='edit.php?id_rincian=$dataa[id_rincian]'>EDIT</a>
              <a href='delete.php?id_rincian=$dataa[id_rincian]'>DELETE</a>
                    </td>
                 </tr>";
                            $no++;
          }
