...
<?php
  ...
  $karyawan          =mysqli_query($koneksi,"SELECT * FROM transaksi  WHERE no_transaksi='$no_transaksi' ");
  $data              =mysqli_fetch_array($karyawan)
  ?>
    <div>

      <label> <input type="hidden" name="no_transaksi" value="<?php echo $data['no_transaksi'];?>"> </label>
    </div>

    <div class="form-group">
        <label>Tanggal Transaksi :</label>
        <input type="text" name="tgl_transaksi" class="form-control" value="<?php echo $data['tgl_transaksi'];?>" required>
    </div>
     <div class="form-group">
        <label>Tanggal Ambil :</label>
        <input type="text" name="tgl_ambil" class="form-control" value="<?php echo $data['tgl_ambil'];?>" required>
    </div>
    <div class="form-group">
        <label>Diskon :</label>
