 ...
 <a class='btn btn-success' href="tambah.php"><span class="glyphicon glyphicon-plus"><font face="Impact"> Tambah Data</font></span></a>
  <center>
      ...
      <tr>
        ...
        <th bgcolor="#1976d2"><font color="white">Kode Pengluaran</font></th>
        ...
        <th bgcolor="#1976d2"><font color="white">OPSI</font></th>
          ...
          <?php
          include'koneksi.php';
          $data =mysqli_query($koneksi,"SELECT pemakaian_barang.kode_pengeluaran,
                                               pemakaian_barang.nik,
                                               pemakaian_barang.kode_barang,
                                               pemakaian_barang.jumlah,
                                               karyawan.nama_karyawan  ,
                                               barang.nama_barang
                                               FROM pemakaian_barang INNER JOIN karyawan ON 
                                               karyawan.nik=pemakaian_barang.nik
                                               INNER JOIN barang ON barang.kode_barang=pemakaian_barang.kode_barang");
          $no=1;
          foreach ($data as $dataa) 
          {
            echo  "<tr>
                <td>$no</td>
                    <td>".$dataa['kode_pengeluaran']."</td>
                    <td>".$dataa['nama_karyawan']."</td>
                    <td>".$dataa['nama_barang']."</td>
                    <td>".$dataa['jumlah']."</td>
                    <td>
              <a href='edit.php?kode_pengeluaran=$dataa[kode_pengeluaran]'>EDIT</a>
              <a href='delete.php?kode_pengeluaran=$dataa[kode_pengeluaran]'>DELETE</a>
                    </td>
                 </tr>";
                            $no++;
          }
