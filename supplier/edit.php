      ...
      <div class="row">
        <div class="panel panel-primary">
          ...
          <table class="table" >
                      ...
                      <h1><b>Tambah Data Supplier </b></h1>
  </center>
  <form action="editpro.php" method="post">
  <?php
  include 'koneksi.php';
  $id_supplier         =$_GET['id_supplier'];
  $karyawan          =mysqli_query($koneksi,"SELECT * FROM supplier  where id_supplier='$id_supplier' ");
  $data              =mysqli_fetch_array($karyawan)
  ?>

    <div class="form-group">
        <input type="hidden" name="id_supplier" class="form-control" value="<?php echo $data['id_supplier'];?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="tlp_supplier" class="form-control" value="<?php echo $data['tlp_supplier'];?>" required>
    </div>
