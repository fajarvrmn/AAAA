...
<html lang="en">
  ...
  <form action="tambahpro.php" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" name="tlp_karyawan" class="form-control" required>
    </div>
    <div class="form-group">
        <label>gender karyawan :</label>
        <input type="text" name="gender_karyawan" class="form-control" required>
    </div>
