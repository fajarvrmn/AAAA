    ...
    <div class="container">
      <div class="row">
        <div class="panel panel-primary">
          ...
          <table class="table" >
                      <h1><b>Edit Data Jenis Laundry</b></h1>
  </center>
  <form action="editpro.php" method="post">
  <?php
  include 'koneksi.php';
  $id_jenis_laundry    =$_GET['id_jenis_laundry'];
  $karyawan          =mysqli_query($koneksi,"SELECT * FROM jenis_laundry  where id_jenis_laundry='$id_jenis_laundry' ");
  $data              =mysqli_fetch_array($karyawan)
  ?>

     <div>
       <label> <input type="hidden" name="id_jenis_laundry" value="<?php echo $data['id_jenis_laundry'];?>"> </label>
     </div>

    <div class="form-group">
        <label>Nama Jenis :</label>
        <input type="text" name="nama_jenis_laundry" class="form-control" required value="<?php echo $data['nama_jenis_laundry'];?>">
    </div>
